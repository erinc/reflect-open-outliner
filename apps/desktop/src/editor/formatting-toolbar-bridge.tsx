...
interface FormattingToolbarBridgeProps {
  ...
  readonly saveFile?: (file: File) => Promise<string | undefined>
}
...
export function FormattingToolbarBridge({
  ...
  useEffect(() => {
    ...
    const attach = (): void => {
      ...
      function readCapabilities(): FormattingToolbarCapabilities {
        return {
          canIndent:
            (!outlineMode || canStrictIndent(editor.state)) && editor.commands.indentList.canExec(),
  ...
  }, [editor, outlineMode, canAttachFiles])
